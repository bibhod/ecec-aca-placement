...
def _do_seed(db: Session):
    ...
    students = [
        Student(id="24abb829-fb8d-46ab-9e43-b55244b5773c", student_id="STU2024004", full_name="Liam Taylor", email="liam.taylor@student.academies.edu.au", phone="0412 345 678", qualification="CHC30121", campus="sydney", status="current", course_start_date=date(2024,2,20), course_end_date=date(2024,11,30), placement_centre_id="centre-001", placement_start_date=date(2024,5,15), placement_end_date=date(2024,10,30), required_hours=160, completed_hours=124, coordinator_id="7f854ead-5e55-4919-b7ac-6a1542d5b46b"),
        Student(id="69147dbb-2f96-446c-bd9f-cdeab63ab3ac", student_id="STU2024002", full_name="Noah Johnson", email="noah.johnson@student.academies.edu.au", phone="0423 456 789", qualification="CHC30121", campus="sydney", status="current", course_start_date=date(2024,3,15), course_end_date=date(2024,12,20), placement_centre_id="centre-002", placement_start_date=date(2024,7,1), placement_end_date=date(2024,11,30), required_hours=160, completed_hours=70, coordinator_id="7f854ead-5e55-4919-b7ac-6a1542d5b46b"),
        Student(id="aa3c8d12-f1b2-4e56-9c78-def012340001", student_id="STU2024003", full_name="Olivia Smith", email="olivia.smith@student.academies.edu.au", phone="0434 567 890", qualification="CHC50121", campus="sydney", status="current", course_start_date=date(2024,1,10), course_end_date=date(2025,6,30), placement_centre_id="centre-002", placement_start_date=date(2024,4,1), placement_end_date=date(2025,3,31), required_hours=280, completed_hours=0, coordinator_id="7f854ead-5e55-4919-b7ac-6a1542d5b46b"),
        Student(id="bb4d9e23-a2c3-5f67-0d89-ef0123456002", student_id="STU2024005", full_name="Emma Williams", email="emma.williams@student.academies.edu.au", phone="0445 678 901", qualification="CHC50121", campus="melbourne", status="current", course_start_date=date(2024,2,1), course_end_date=date(2025,7,31), placement_centre_id="centre-003", placement_start_date=date(2024,5,1), placement_end_date=date(2025,4,30), required_hours=280, completed_hours=147, coordinator_id="86e12151-deac-4815-802a-25d73f82a2b9"),
        Student(id="cc5e0f34-a3d4-6a78-1e90-f01234567003", student_id="STU2024001", full_name="Sophie Brown", email="sophie.brown@student.academies.edu.au", phone="0456 789 012", qualification="CHC50121", campus="sydney", status="current", course_start_date=date(2024,3,1), course_end_date=date(2025,8,31), placement_centre_id="centre-004", placement_start_date=date(2024,6,1), placement_end_date=date(2025,5,31), required_hours=280, completed_hours=109, coordinator_id="7f854ead-5e55-4919-b7ac-6a1542d5b46b"),
        Student(id="dd6f1045-a4e5-7b89-2f01-012345678004", student_id="202512345", full_name="Mike Quinn", email="mike.quinn@student.academies.edu.au", phone="0467 890 123", qualification="CHC30121", campus="melbourne", status="current", course_start_date=date(2025,1,15), course_end_date=date(2025,12,15), placement_centre_id="centre-005", placement_start_date=date(2025,3,1), placement_end_date=date(2025,11,30), required_hours=160, completed_hours=29.3, coordinator_id="86e12151-deac-4815-802a-25d73f82a2b9"),
        Student(id="ee7a2156-b5f6-8c90-3a12-123456789005", student_id="STU2024006", full_name="Jessica Lee", email="jessica.lee@student.academies.edu.au", phone="0478 901 234", qualification="CHC30121", campus="sydney", status="current", course_start_date=date(2024,4,1), course_end_date=date(2024,12,31), placement_centre_id="centre-002", placement_start_date=date(2024,6,15), placement_end_date=date(2024,12,15), required_hours=160, completed_hours=45, coordinator_id="7f854ead-5e55-4919-b7ac-6a1542d5b46b"),
        Student(id="ff8b3267-c6a7-9d01-4b23-234567890006", student_id="STU2024007", full_name="Daniel Park", email="daniel.park@student.academies.edu.au", phone="0489 012 345", qualification="CHC50121", campus="melbourne", status="current", course_start_date=date(2024,2,15), course_end_date=date(2025,9,30), placement_centre_id=None, required_hours=280, completed_hours=0, coordinator_id="86e12151-deac-4815-802a-25d73f82a2b9"),
    ]
